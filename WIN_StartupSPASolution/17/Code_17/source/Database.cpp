...
void Database::insertNext(string prevStmtNo, string stmtNo, string direct) {
	Database::executeQuery(generateInsertQuery("nexts", { "prevStmtNo", "stmtNo", "direct"}, { prevStmtNo, stmtNo, direct}));
}
